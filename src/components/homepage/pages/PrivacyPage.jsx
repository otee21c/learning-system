      ...
      <div className="hp-page-container">
        ...
        <div className="hp-page-content hp-privacy">
          <p className="hp-privacy-intro">
            오늘의 국어 연구소(이하 "연구소")는 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고, 
            개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
          </p>

          <div className="hp-privacy-section">
            <h2>제1조 (개인정보의 수집 항목 및 수집 방법)</h2>
            <p>연구소는 상담 및 서비스 제공을 위해 아래와 같은 개인정보를 수집하고 있습니다.</p>
            
            <p><strong>1. 홈페이지 문자 상담 시 수집 항목</strong></p>
            <ul>
              <li>필수 항목: 학생 이름, 학교/학년, 전화번호</li>
              <li>선택 항목: 통화 가능 시간, 상담 내용</li>
            </ul>
            
            <p><strong>2. 학습관리시스템(LMS) 이용 시 수집 항목</strong></p>
            <ul>
              <li>필수 항목: 학생 이름, 학교, 학년, 학생 연락처, 학부모 연락처</li>
              <li>선택 항목: 학습 관련 메모, 상담 내역</li>
              <li>자동 수집 항목: 출결 정보, 성적 정보(시험 점수, OMR 채점 결과)</li>
            </ul>
            
            <p><strong>3. 수집 방법</strong></p>
            <ul>
              <li>홈페이지 문자 상담 신청</li>
              <li>학습관리시스템(LMS) 등록</li>
              <li>전화 및 방문 상담</li>
            </ul>
          </div>
          ...
          <div className="hp-privacy-section">
            ...
            <p>연구소는 수집한 개인정보를 다음의 목적을 위해 활용합니다.</p>
            <ul>
              <li>상담 서비스 제공 및 상담 일정 조율</li>
              <li>학습 컨설팅 및 수업 안내</li>
              <li>학생별 맞춤 학습 관리 및 성적 분석</li>
              <li>출결 관리 및 학부모 안내</li>
              <li>문의사항 응대 및 처리</li>
              <li>학습 관련 공지사항 및 정보 전달</li>
            </ul>
          </div>

          <div className="hp-privacy-section">
            <h2>제3조 (개인정보의 보유 및 이용 기간)</h2>
            <p>연구소는 개인정보 수집 및 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.</p>
            <ul>
              <li>상담 신청 정보: 상담 완료 후 1년</li>
              <li>학습관리시스템(LMS) 정보: 수강 종료 후 1년</li>
          ...
          <div className="hp-privacy-section">
            ...
            <p>연구소는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.</p>
            <ul>
          ...
          <div className="hp-privacy-section">
            ...
            <p>연구소는 개인정보 보유 기간의 경과, 처리 목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체 없이 해당 개인정보를 파기합니다.</p>
            <ul>
          ...
          <div className="hp-privacy-section">
            ...
            <p>이용자(학생, 학부모)는 언제든지 자신의 개인정보에 대해 열람, 정정, 삭제, 처리정지를 요청할 수 있습니다.</p>
            <p>위 권리 행사는 연구소에 대해 서면, 전화, 이메일 등을 통해 하실 수 있으며, 연구소는 이에 대해 지체 없이 조치하겠습니다.</p>
          </div>

          <div className="hp-privacy-section">
            <h2>제7조 (개인정보 보호책임자)</h2>
            <p>연구소는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 이용자의 불만 처리 및 피해 구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
